...
public class NumberPickerDialogPreference extends DialogPreference
{
    ...
    public void setFormat(boolean format, int newMin){
        this.format = format;
        this.newMin = newMin;
    }
    ...
    protected void onBindDialogView(View view)
    {
        ...
        mNumberPicker = (NumberPicker) view.findViewById(R.id.number_picker_waiting);
        ...
        if (format){
            mNumberPicker.setFormatter(new NumberPicker.Formatter() {
                ...
                public String format(int index) {
                    return Integer.toString(index - newMin);
                }
            });
        }
    }
