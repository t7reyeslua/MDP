...
public class SettingsActivity extends PreferenceActivity {
    ...
    private void setupSimplePreferencesScreen() {
        ...
        getPreferenceScreen().addPreference(fakeHeader);
        addPreferencesFromResource(R.xml.pref_location_tracker);

        /*
        fakeHeader = new PreferenceCategory(this);
        fakeHeader.setTitle("Device Manager");
        getPreferenceScreen().addPreference(fakeHeader);
        addPreferencesFromResource(R.xml.pref_device_manager);
        */
        ...
        bindPreferenceSummaryToValue(findPreference(UserPreferences.CALIBRATION_M_PREF));
        bindPreferenceSummaryToValue(findPreference(UserPreferences.CALIBRATION_B_PREF));
        bindPreferenceSummaryToValue(findPreference(UserPreferences.CALIBRATION_SCANS));
        bindPreferenceSummaryToValue(findPreference(UserPreferences.ALPHA_TRIMMER_COEFFICIENT));
     ...
     */
    @TargetApi(Build.VERSION_CODES.HONEYCOMB)
    public static class LocationTrackerPreferenceFragment extends PreferenceFragment {
        @Override
        public void onCreate(Bundle savedInstanceState) {
            super.onCreate(savedInstanceState);
            addPreferencesFromResource(R.xml.pref_location_tracker);
     ...
     */
    @TargetApi(Build.VERSION_CODES.HONEYCOMB)
    public static class DeviceManagerPreferenceFragment extends PreferenceFragment {
        @Override
        public void onCreate(Bundle savedInstanceState) {
            super.onCreate(savedInstanceState);
            addPreferencesFromResource(R.xml.pref_device_manager);
