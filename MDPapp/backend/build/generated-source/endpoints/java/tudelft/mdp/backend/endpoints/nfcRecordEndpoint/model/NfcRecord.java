...
public final class NfcRecord extends com.google.api.client.json.GenericJson {
   ...
   */
  public NfcRecord setState(java.lang.Boolean state) {
    this.state = state;
    return this;
  }
   ...
   */
  public NfcRecord setTimestamp(java.lang.Double timestamp) {
   ...
   */
  public NfcRecord setUser(java.lang.String user) {
    this.user = user;
    return this;
  }
