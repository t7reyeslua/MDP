 ...
 * on 2014-11-08 at 00:46:02 UTC 
 * Modify at your own risk.
 */

package tudelft.mdp.backend.endpoints.registration;

/**
 * Service definition for Registration (v1).
 *
 * <p>
 * An API to manage the device GCM registration
 * </p>
 *
 * <p>
...
public class Registration extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class ListDevices extends RegistrationRequest<tudelft.mdp.backend.endpoints.registration.model.CollectionResponseRegistrationRecord> {
    ...
    protected ListDevices(java.lang.Integer count) {
      super(Registration.this, "GET", REST_PATH, null, tudelft.mdp.backend.endpoints.registration.model.CollectionResponseRegistrationRecord.class);
   ...
   *
   * @param content the {@link tudelft.mdp.backend.endpoints.registration.model.RegistrationRecord}
   * @return the request
   */
  public Register register(tudelft.mdp.backend.endpoints.registration.model.RegistrationRecord content) throws java.io.IOException {
  ...
  public class Register extends RegistrationRequest<Void> {
     ...
     * @since 1.13
     */
    protected Register(tudelft.mdp.backend.endpoints.registration.model.RegistrationRecord content) {
