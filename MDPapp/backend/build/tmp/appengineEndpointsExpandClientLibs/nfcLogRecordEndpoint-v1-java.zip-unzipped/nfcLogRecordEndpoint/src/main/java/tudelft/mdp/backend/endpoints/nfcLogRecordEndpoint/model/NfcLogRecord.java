...
package tudelft.mdp.backend.endpoints.nfcLogRecordEndpoint.model;

/**
 * Model definition for NfcLogRecord.
 *
 * <p> This is the Java data model class that specifies how to parse/serialize into the JSON that is
 * transmitted over HTTP when working with the nfcLogRecordEndpoint. For a detailed explanation see:
